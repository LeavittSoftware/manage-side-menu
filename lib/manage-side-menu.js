...
let ManageSideMenu = class ManageSideMenu extends PolymerElement {
    constructor() {
        super(...arguments);
        this.page = '';
        this.devPrefix = '';
...
], ManageSideMenu.prototype, "page", void 0);
__decorate([
    property({ reflectToAttribute: true, type: String })
], ManageSideMenu.prototype, "devPrefix", void 0);
__decorate([
    property({ reflectToAttribute: true, type: Array })
], ManageSideMenu.prototype, "roles", void 0);
__decorate([
    property({ reflectToAttribute: true, type: Boolean })
], ManageSideMenu.prototype, "isDev", void 0);
__decorate([
    queryAll('a')
], ManageSideMenu.prototype, "links", void 0);
__decorate([
    queryAll('div[category]')
], ManageSideMenu.prototype, "categories", void 0);
ManageSideMenu = __decorate([
    customElement('manage-side-menu')
], ManageSideMenu);
export { ManageSideMenu };
