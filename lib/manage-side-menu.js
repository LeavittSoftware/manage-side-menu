...
let ManageSideMenuElement = class ManageSideMenuElement extends PolymerElement {
    constructor() {
        super(...arguments);
        this.page = '';
        this.devPrefix = '';
    ...
    _onRoleChange() {
        ...
        this.categories.forEach((category) => {
            let visibleSubcategoryList = this.querySelectorAll('a[parent-category="' + category.getAttribute('category') + '"]');
            visibleSubcategoryList =
                Array.prototype.slice.call(visibleSubcategoryList);
            let visibleSubcategories = [];
            visibleSubcategoryList.forEach((subCat) => {
...
], ManageSideMenuElement.prototype, "page", void 0);
__decorate([
    property({ reflectToAttribute: true, type: String })
], ManageSideMenuElement.prototype, "devPrefix", void 0);
__decorate([
    property({ reflectToAttribute: true, type: Array })
], ManageSideMenuElement.prototype, "roles", void 0);
__decorate([
    property({ reflectToAttribute: true, type: Boolean })
], ManageSideMenuElement.prototype, "isDev", void 0);
__decorate([
    queryAll('a')
], ManageSideMenuElement.prototype, "links", void 0);
__decorate([
    queryAll('div[category]')
], ManageSideMenuElement.prototype, "categories", void 0);
__decorate([
    observe('isDev')
], ManageSideMenuElement.prototype, "_isDevChanged", null);
__decorate([
    observe('roles.splices')
], ManageSideMenuElement.prototype, "_onRoleChange", null);
ManageSideMenuElement = __decorate([
    customElement('manage-side-menu')
], ManageSideMenuElement);
export { ManageSideMenuElement };
//# sourceMappingURL=manage-side-menu.js.map